...
const connectDB = () => {
  const uri = process.env.MONGODB_URI || "mongodb+srv://mdibrahimbjs:mdibrahim123@cluster0.ahxadg0.mongodb.net/Chattu"

  mongoose
    .connect(uri)
    .then((data) => console.log(`Connected to MongoDB Atlas: ${data.connection.host}`))
    .catch((err) => {
